...
class MicVAD {
    constructor(options, frameProcessor, model, frameSamples, listening = false, errored = null, _stream = null, _audioContext = null, _vadNode = null, _mediaStreamAudioSourceNode = null, _audioProcessorAdapterType = null, initializationState = "uninitialized", ownsAudioContext = false) {
        ...
        this.destroy = async () => {
            ...
            if (this._vadNode instanceof AudioWorkletNode) {
                try {
                    this._vadNode.port.postMessage(messages_1.Message.SpeechStop);
                }
                catch (e) { }
            }
            if (this.listening) {
            ...
            try {
                if (this.model) await this.model.release();
            }
            catch (e) { }
            if (this.ownsAudioContext && this._audioContext) {
                try {
